...
const separatorOptions = [
  { value: "", label: "None", preview: "examplepassword" },
  { value: "-", label: "Dash", preview: "example-password" },
  { value: "_", label: "Underscore", preview: "example_password" },
  { value: ".", label: "Dot", preview: "example.password" },
];
